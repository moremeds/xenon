...
def test_base_signal_hit_creation():
    from xenon.scanners._shared.models import BaseSignalHit
...
def test_base_context_flag_creation():
    from xenon.scanners._shared.models import BaseContextFlag
...
def test_base_scan_candidate_creation():
    from xenon.scanners._shared.models import BaseScanCandidate
