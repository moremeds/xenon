...
def test_score_iv_rank_low():
    from xenon.scanners.trend.stages.volatility import score_iv_rank
...
def test_score_term_structure_normal():
    from xenon.scanners.trend.stages.volatility import score_term_structure
...
def test_score_iv_rv_ratio_cheap():
    from xenon.scanners.trend.stages.volatility import score_iv_rv_ratio
...
def test_suggest_trade_type_cheap():
    from xenon.scanners.trend.stages.volatility import suggest_trade_type
