...
def test_stage_a_data_rejects_below_market_cap():
    from xenon.scanners.trend.cli import _stage_a_data
...
def test_filter_universe_to_covered_a19(tmp_path: Path):
    ...
    from xenon.scanners.trend.cli import _filter_universe_to_covered
...
def test_scanner_timeframes_constant_is_tuple_of_strings():
    ...
    from xenon.scanners.trend.cli import _SCANNER_TIMEFRAMES
