...
def test_score_ma_alignment_full_stack():
    from scripts.scanners.trend.stages.ta_prefilter import score_ma_alignment
...
def test_score_rsi_constructive():
    from scripts.scanners.trend.stages.ta_prefilter import score_rsi
...
def test_score_adx_strong_trend():
    from scripts.scanners.trend.stages.ta_prefilter import score_adx
...
def test_score_macd_bullish():
    from scripts.scanners.trend.stages.ta_prefilter import score_macd
...
def test_score_relative_strength_outperforming():
    from scripts.scanners.trend.stages.ta_prefilter import score_relative_strength
...
def test_score_slope_positive():
    from scripts.scanners.trend.stages.ta_prefilter import score_slope
...
def test_score_volume_profile_above_avg():
    from scripts.scanners.trend.stages.ta_prefilter import score_volume_profile
...
def test_score_bbw_squeeze():
    from scripts.scanners.trend.stages.ta_prefilter import score_bbw
...
def test_breakout_near_52w_high():
    from scripts.scanners.trend.stages.ta_prefilter import detect_breakout
...
def test_bullish_gate_passes():
    from scripts.scanners.trend.stages.ta_prefilter import passes_bullish_gate
...
def test_compute_trend_score_strong_trend():
    from scripts.scanners.trend.stages.ta_prefilter import compute_trend_score
