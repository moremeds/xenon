...
from xenon.fetchers import fetch_menthorq_cta as fetch_menthorq_cta_module
from xenon.fetchers.fetch_menthorq_cta import (
    CACHE_DIR,
    CTA_TABLES,
    EXTRACTION_PROMPT,
    cache_path,
...
class TestCacheReadWrite:
    ...
    def test_write_and_read_cache(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("xenon.fetchers.fetch_menthorq_cta.CACHE_DIR", tmp_path)
