...
def test_weighted_composite_basic():
    from xenon.scanners._shared.scoring import weighted_composite
...
def test_passes_min_thresholds_all_pass():
    from xenon.scanners._shared.scoring import passes_min_thresholds
...
def test_normalize_score_clamps():
    from xenon.scanners._shared.scoring import normalize_score
