...
class TestFormattingModule:
    ...
    def test_format_currency_positive(self):
        from xenon.trade_blotter.formatting import format_currency
    ...
    def test_format_pnl_positive(self):
        from xenon.trade_blotter.formatting import format_pnl
...
class TestCliImportsFromFormatting:
    ...
    def test_cli_format_currency_matches(self):
        from xenon.trade_blotter.formatting import format_currency as fmt_orig
        from xenon.trade_blotter.cli import format_currency as fmt_cli
    ...
    def test_cli_format_pnl_matches(self):
        from xenon.trade_blotter.formatting import format_pnl as fmt_orig
        from xenon.trade_blotter.cli import format_pnl as fmt_cli
    ...
    def test_cli_has_no_local_format_currency_def(self):
        ...
        import inspect
        from xenon.trade_blotter import cli as cli_mod
...
class TestFlexQueryImportsFromFormatting:
    ...
    def test_flex_format_currency_matches(self):
        from xenon.trade_blotter.formatting import format_currency as fmt_orig
        from xenon.trade_blotter.flex_query import format_currency as fmt_flex
        for val in [Decimal("0"), Decimal("1234.56"), Decimal("-99.99")]:
            assert fmt_orig(val) == fmt_flex(val)

    def test_flex_format_pnl_matches(self):
        from xenon.trade_blotter.formatting import format_pnl as fmt_orig
        from xenon.trade_blotter.flex_query import format_pnl as fmt_flex
        for val in [Decimal("0"), Decimal("100"), Decimal("-50")]:
            assert fmt_orig(val) == fmt_flex(val)
    ...
    def test_flex_has_no_local_format_currency_def(self):
        ...
        import inspect
        from xenon.trade_blotter import flex_query as fq_mod
