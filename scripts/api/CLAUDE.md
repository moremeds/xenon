...
FastAPI bridge between Next.js and IB/UW/MenthorQ. Root `CLAUDE.md` is authoritative for policy; this file covers API infrastructure, auth, IB Gateway lifecycle, and order semantics.
