...
# Ensure project root is on sys.path when run as subprocess from scripts/scanners/trend/.
...
from scripts.scanners.trend.stages.ta_prefilter import (
    compute_trend_score,
    passes_bearish_gate,
    passes_bullish_gate,
)
...
from scripts.scanners.trend.ranking import apply_min_thresholds, compute_final_score, rank_candidates
from scripts.scanners.trend.storage import (
    DEFAULT_DB_PATH,
    get_connection,
    init_schema,
