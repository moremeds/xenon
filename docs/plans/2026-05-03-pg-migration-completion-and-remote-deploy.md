...
| 1.6  | GHCR push job in `.github/workflows/release.yml` — fires on tag, builds 4 images, tags `:vX.Y.Z` + `:latest`, pushes to `ghcr.io/<owner>/xenon-{api,web,realtime,migrator}`                                                                                               | 1 hr                       |
