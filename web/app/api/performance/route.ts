...
/** Forwards `?broker=IB|FUTU` to FastAPI's `/performance`. FastAPI owns the
 *  TTL cache (market-aware 60s open / 30min closed) — no second-level cache
 *  here, since duplicating it leads to stale-after-write surprises. */
