...
Usage:
  ...
  python3 -m xenon.monitor_daemon.run --once

  # Run as daemon (continuous loop)
  python3 -m xenon.monitor_daemon.run --daemon

  # Status check
  python3 -m xenon.monitor_daemon.run --status

  # List handlers
  python3 -m xenon.monitor_daemon.run --list-handlers
"""
...
def main():
    parser = argparse.ArgumentParser(description="Extensible monitoring daemon for Xenon")

    parser.add_argument("--once", action="store_true", help="Run all handlers once and exit")
    parser.add_argument("--daemon", action="store_true", help="Run continuously as daemon")
    parser.add_argument("--status", action="store_true", help="Show daemon status")
    parser.add_argument("--list-handlers", action="store_true", help="List available handlers")
    parser.add_argument("--verbose", "-v", action="store_true", help="Verbose logging")
    parser.add_argument("--ignore-market-hours", action="store_true", help="Run even outside market hours")
