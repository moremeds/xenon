...
def modify_order(
    ...
    if confirmed_trade is None:
        ...
        # [modify-debug] Surface ALL IB error events captured during the attempt.
        # The "fatal" filter above only catches 103/201/202; non-fatal codes
        # like 10147 (order not found), 326 (clientId in use), or even
        # successful warnings get swallowed otherwise.
