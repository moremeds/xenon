...
def build_tweet(data: dict, ds: str) -> str:
    ...
    if triggered:
        ...
        hook = f"🟠 CRI at {score:.0f}/100 — significant stress across vol, correlation, and CTA positioning."
        thesis = (
        ...
        hook = f"⚠️ CRI at {score:.0f}/100 — elevated but not crisis. The risk regime has shifted ({month_day})."
        thesis = (
        ...
        hook = f"📊 CRI at {score:.0f}/100 — risk regime is calm. No structural stress detected ({month_day})."
        thesis = (
        ...
        cta_note = f"CTA equity exposure at {exposure:.0f}% — normal range, no forced selling in the pipeline."
